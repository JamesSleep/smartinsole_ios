...
export default function Pressure({data}) {
    const left = data.left.press;
    const right = data.right.press;
    ...
    return (
        ...
        <Image source={require('../../image/bal.png')} style={styles.footImg}/>
            ...
            <RadialGradient style={{width:40,height:40, position:'absolute',left:"23%",bottom:"30%",zIndex:1,}}
                colors={[color[colorHandler(left[5])].inner,color[colorHandler(left[5])].outer,"rgba(214,215,220,0)"]}
                stops={[0.1,0.5,1]}
                center={[20,20]}
                radius={20}/>
            {/* PL6 */}
            <RadialGradient style={{width:40,height:40, position:'absolute',left:"13%",bottom:"22%",zIndex:1,}}
                colors={[color[colorHandler(left[6])].inner,color[colorHandler(left[6])].outer,"rgba(214,215,220,0)"]}
                stops={[0.1,0.5,1]}
                center={[20,20]}
                radius={20}/>
            {/* PL7 */}
            <RadialGradient style={{width:40,height:40, position:'absolute',left:"20%",bottom:"12%",zIndex:1,}}
                colors={[color[colorHandler(left[7])].inner,color[colorHandler(left[7])].outer,"rgba(214,215,220,0)"]}
                stops={[0.1,0.5,1]}
                center={[20,20]}
                radius={20}/>
            {/* PL8 */}
            <RadialGradient style={{width:40,height:40, position:'absolute',left:"28%",bottom:"20%",zIndex:1,}}
                colors={[color[colorHandler(left[8])].inner,color[colorHandler(left[8])].outer,"rgba(214,215,220,0)"]}
                stops={[0.1,0.5,1]}
                center={[20,20]}
                radius={20}/>
            ...
            <RadialGradient style={{width:40,height:40, position:'absolute',right:"23%",bottom:"30%",zIndex:1,}}
                colors={[color[colorHandler(right[5])].inner,color[colorHandler(right[5])].outer,"rgba(214,215,220,0)"]}
                stops={[0.1,0.5,1]}
                center={[20,20]}
                radius={20}/>
            {/* PR6 */}
            <RadialGradient style={{width:40,height:40, position:'absolute',right:"13%",bottom:"22%",zIndex:1,}}
                colors={[color[colorHandler(right[6])].inner,color[colorHandler(right[6])].outer,"rgba(214,215,220,0)"]}
                stops={[0.1,0.5,1]}
                center={[20,20]}
                radius={20}/>
            {/* PR7 */}
            <RadialGradient style={{width:40,height:40, position:'absolute',right:"20%",bottom:"12%",zIndex:1,}}
                colors={[color[colorHandler(right[7])].inner,color[colorHandler(right[7])].outer,"rgba(214,215,220,0)"]}
                stops={[0.1,0.5,1]}
                center={[20,20]}
                radius={20}/>
            {/* PR8 */}
            <RadialGradient style={{width:40,height:40, position:'absolute',right:"28%",bottom:"20%",zIndex:1,}}
                colors={[color[colorHandler(right[8])].inner,color[colorHandler(right[8])].outer,"rgba(214,215,220,0)"]}
                stops={[0.1,0.5,1]}
                center={[20,20]}
                radius={20}/>
        </>
